...
import Signal from "../../assets/images/signal lines.png";
    ...
    <div className="container mx-auto px-8 py-8 flex flex-col md:flex-row items-center">
      ...
      <div className="w-full md:w-1/2 -ml-16">
        ...
        <h2 className="text-4xl font-bold text-black mb-4 ml-10">
          ...
          The <span className="text-sky-400">Benefits</span> of Utilizing Webapp for Doctors
        ...
        <ul className="space-y-8">
          <li className="flex flex-col items-center md:flex-row md:items-start">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold text-black">Secured Maintenance</h3>
          ...
          <li className="flex flex-col items-center md:flex-row md:items-start">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold text-black">Integrated Diagnosis</h3>
              <p className="text-gray-700">
          ...
          <li className="flex flex-col items-center md:flex-row md:items-start">
            ...
            <div className="text-center md:text-left">
              <h3 className="text-xl font-semibold text-black">Online Communication</h3>
              <p className="text-gray-700">
